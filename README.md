...
1. Generate an OSM query file for the region you want to study.
	...
	- Click on the region you want, which should open a page for a `relation` that says something like "Relation: Victoria (2221062)" at the top.
	- Scroll down in the list of tags until you find `wikidata`, i.e. `wikidata:Q2132` for Victoria, Canada.
