...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Build OSM Overpass query file based on location"
    )
    parser.add_argument(
        "region", type=str, nargs="?", help="Name of region (used for file saving)"
    )
    parser.add_argument(
        "key",
        type=str,
    ...
    parser.add_argument(
        "value", type=str, nargs="?", help="OSM value for relation to download"
    )
